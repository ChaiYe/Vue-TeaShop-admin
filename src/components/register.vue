        ...
        <div class="registered">
          ...
          <div class="content" style="margin-top: 20px;">
                ...
                <div style="margin-top: 40px;" class="input">
                  <el-input type="text"
                         v-model="registered.userName" placeholder="账号"
                            @keyup="registered.userName=registered.userName.replace(/[^\w\.\/]/ig,'')"></el-input>
                </div>
              </li>
              <li>
                <div class="input">
            ...
            <el-checkbox class="agree" v-model="agreement">
              我已阅读并同意遵守
              <a @click="open('法律声明','不承担任何法律问题')">法律声明</a> 和
              <a @click="open('隐私条款','本网站将严格遵守有关法律法规和本隐私政策所载明的内容收集、使用您的信息')">隐私条款</a>
            </el-checkbox>
