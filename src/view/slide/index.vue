  ...
  <div>
    <el-dialog :title="this.dialogStatus == 'create' ?'添加':'修改'"  :visible.sync="this.display.dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" v-if="dialogStatus=='create'" @click="createslide">创建</el-button>
    ...
    <div>
      ...
      <el-row class="header">
        <el-col :span="22" >
          <el-form :inline="true" :model="pageInfo" >
            ...
            <el-form-item>
              <el-select v-model="pageInfo.type" placeholder="请选择">
      ...
      <el-row class="main">
        ...
        <el-table :data="slide" border height="250" ref="slide">
          <el-table-column prop="id" label="ID"></el-table-column>
          <el-table-column prop="title" label="标题"></el-table-column>
          <el-table-column prop="thumbnailPic" label="缩略图"></el-table-column>
          <el-table-column  prop="modifyTime" :formatter="dateFormat" label="编辑时间"></el-table-column>
          <el-table-column  prop="picSort" label="排序序号"></el-table-column>
    ...
    methods: {
      ...
      handleDelete(index, row){
        ...
        this.$confirm('确定删除此口味?', '提示', {
          ...
          this.$http.post(this.HOST+"sys/slide/delete",row).then((response)=>{
      ...
      /*提交修改*/
      updateslide(){
        this.$http.post(this.HOST+"sys/slide/update",this.add).then((response)=>{
          this.request();
      ...
      /*添加*/
      createslide(){
        this.$http.post(this.HOST+"sys/slide/add",this.add).then((response)=>{
          this.request();
          this.display.dialogFormVisible = false;
        }).catch((error)=>{
      ...
      request() {
        ...
        this.$http.get(this.HOST + "/sys/slide/list", {
              params:this.pageInfo
          }
        ).then((response) => {
          console.log(response);
          this.slide= response.data.list;
